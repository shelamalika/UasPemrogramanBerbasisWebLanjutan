      ...
      <div class="col-sm-6">
        <form class="row g-3 mt-4" action="" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('model') is-invalid @enderror" name="model" id="model" value="{{ $golongan->model }}" placeholder="Model">
            @error('model')
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('ukuran') is-invalid @enderror" name="ukuran" id="ukuran" value="{{ $golongan->ukuran }}" placeholder="Ukuran">
            @error('ukuran')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
